...
# print("Rozkład klas we wszystkich zbiorach danych:")
# print(tabulate(all_class_distributions, headers="keys", tablefmt="grid"))
# os.makedirs("results", exist_ok=True)
# output_file_path = os.path.join("results", f"class_imbalance_ratios.txt")
...
print("\nStosunek niezbalansowania w zbiorach danych:")
print(
    tabulate(
        imbalance_table,
        headers="keys",
